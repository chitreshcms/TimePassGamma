...
public class AddRemovemovietheatersFragment extends ibmmobileappbuilder.ui.DetailFragment<Item>  {

    private Datasource<Item> datasource;
    private SearchOptions searchOptions;

    public static AddRemovemovietheatersFragment newInstance(Bundle args){
        AddRemovemovietheatersFragment card = new AddRemovemovietheatersFragment();
        card.setArguments(args);

        return card;
    }

    public AddRemovemovietheatersFragment(){
        super();
    }
    ...
    protected int getLayout() {
        return R.layout.addremovemovietheaters_custom;
    }
    ...
    protected void onShow(Item item) {
        ...
        getActivity().setTitle("Add/Remove movie theaters");
    }
